...
class SequentialCIFAR10Inv(ContinualDataset):

    NAME = 'seq-cifar10-inv'
    SETTING = 'class-il'
    ...
    def get_data_loaders(self, args):
        ...
        train_dataset.targets = 9 - np.array(train_dataset.targets)
        memory_dataset.targets = 9 - np.array(memory_dataset.targets)
        test_dataset.targets = 9 - np.array(test_dataset.targets)
